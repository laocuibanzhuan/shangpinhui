      ...
      <div class="goods">
        <div class="left-good">
          ...
          <div class="right-info">
            ...
            <span v-for="(item, index) in attr" :key="index">{{ item }}</span>
            <p class="attr">数量：{{ num }}</p>
          </div>
        </div>
        <div class="right-gocart">
          <router-link
            :to="{ name: 'detail', params: { goodsId: this.$route.params.id } }"
...
export default {
  ...
  mounted() {
    this.$store.dispatch("detail/getDetail", this.$route.params.id);
  },
};
</script>
